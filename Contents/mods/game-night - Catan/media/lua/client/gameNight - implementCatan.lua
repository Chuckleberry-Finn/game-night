...
gamePieceAndBoardHandler.registerSpecial("Base.CatanRoadWhite", {
    ...
    alternateStackRendering = { func="DrawTextureCardFace", depth=8, rgb = {0.541, 0.525, 0.510}, sides=7 } })

gamePieceAndBoardHandler.registerSpecial("Base.CatanRoadRed", {
    actions = { rotateRoad=true }, shiftAction = "rotateRoad",
    alternateStackRendering = { func="DrawTextureCardFace", depth=8, rgb = {0.451, 0.153, 0.173}, sides=7 } })

gamePieceAndBoardHandler.registerSpecial("Base.CatanRoadBlue", {
    actions = { rotateRoad=true }, shiftAction = "rotateRoad",
    alternateStackRendering = { func="DrawTextureCardFace", depth=8, rgb = {0.176, 0.239, 0.329}, sides=7 } })

gamePieceAndBoardHandler.registerSpecial("Base.CatanRoadOrange", {
    actions = { rotateRoad=true }, shiftAction = "rotateRoad",
    alternateStackRendering = { func="DrawTextureCardFace", depth=8, rgb = {0.545, 0.388, 0.208}, sides=7 } })
