...
gamePieceHandler.registerSpecial("Base.CatanResourceDeck",{ actions = {examine=true}, textureSize = {90,133} })
...
gamePieceHandler.registerSpecial("Base.CatanDevelopmentDeck",{ actions = {examine=true}, textureSize = {90,133} })
...
--gamePieceHandler.registerTypes({})
--NOTE: registerSpecial auto-registers the type as well.

---Register special cases for modifying parts of the item
--- For example, as the board is registered to the game-system it would be considered a 'GamePiece'
--- This `special` case changes the category from `GamePiece` to `GameBoard`.
gamePieceHandler.registerSpecial("Base.CatanBoard", {
...
gamePieceHandler.registerSpecial("Base.CatanPlayerCostsWhite",{
...
gamePieceHandler.registerSpecial("Base.CatanPlayerCostsRed",{
    shiftAction = "examine", actions = {examine=true}, textureSize = {100,123},
        alternateStackRendering = { func="DrawTextureCardFace", depth=3, rgb = {0.651, 0.353, 0.373} }
})

gamePieceHandler.registerSpecial("Base.CatanPlayerCostsOrange",{
    shiftAction = "examine", actions = {examine=true}, textureSize = {100,123},
    alternateStackRendering = { func="DrawTextureCardFace", depth=3, rgb = {0.745, 0.588, 0.408} }
})

gamePieceHandler.registerSpecial("Base.CatanPlayerCostsBlue",{
    shiftAction = "examine", actions = {examine=true}, textureSize = {100,123},
    alternateStackRendering = { func="DrawTextureCardFace", depth=3, rgb = {0.376, 0.439, 0.529} }
})

gamePieceHandler.registerSpecial("Base.CatanLongestRoad",{
    shiftAction = "examine", actions = {examine=true}, textureSize = {100,123},
    alternateStackRendering = { func="DrawTextureCardFace", depth=3, rgb = {0.741, 0.725, 0.710} }
})

gamePieceHandler.registerSpecial("Base.CatanLargestArmy",{
    shiftAction = "examine", actions = {examine=true}, textureSize = {100,123},
    alternateStackRendering = { func="DrawTextureCardFace", depth=3, rgb = {0.741, 0.725, 0.710} }
})

gamePieceHandler.registerSpecial("Base.CatanCityWhite", { noRotate=true, })
gamePieceHandler.registerSpecial("Base.CatanCityRed", { noRotate=true, })
gamePieceHandler.registerSpecial("Base.CatanCityBlue", { noRotate=true, })
gamePieceHandler.registerSpecial("Base.CatanCityOrange", { noRotate=true, })

gamePieceHandler.registerSpecial("Base.CatanSettlementWhite", { noRotate=true, })
gamePieceHandler.registerSpecial("Base.CatanSettlementRed", { noRotate=true, })
gamePieceHandler.registerSpecial("Base.CatanSettlementBlue", { noRotate=true, })
gamePieceHandler.registerSpecial("Base.CatanSettlementOrange", { noRotate=true, })

gamePieceHandler.registerSpecial("Base.CatanRobber", { noRotate=true, })

gamePieceHandler.registerSpecial("Base.CatanRoadWhite", {
...
function gamePieceHandler.rotateRoad(gamePiece, player, x, y,z)
    ...
    gamePieceHandler.pickupAndPlaceGamePiece(player, gamePiece, {gamePieceHandler.setModDataValue, gamePiece, "gameNight_rotation", state}, nil, x, y,z)
end
