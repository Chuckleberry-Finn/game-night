if getActivatedMods():contains("ChuckleberryFinnAlertSystem") then
    ...
    if alertSystem then
        alertSystem.addTexture("common/media/textures/donate/1.png")
        alertSystem.addTexture("common/media/textures/donate/2.png")
        --alertSystem:receiveAlert("Brand new scaling feature! Play-Game UI can now scale to 1x, 1.5x, and 2x.")
    end

else
    print("WARNING: Highly recommended to install `ChuckleberryFinnAlertSystem` (Workshop ID: `3077900375`) for latest news and updates.")
end